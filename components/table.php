<div class="table-responsive rounded overflow-hidden ">
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination d-flex justify-content-center gap-1">
            <?php if ($page > 1): ?> <li class="page-item"><a class="page-link fw-bold" href="katalog.php?page=<?= $page - 1 ?>">Previous</a></li><?php endif; ?>
            <li class="page-item px-1"><span class="page-link fw-bold" href="#"><?= $page."/".$total_page?></span></li>
            <?php if ($page < $total_page): ?> <li class="page-item"><a class="page-link fw-bold" href="katalog.php?page=<?= $page + 1 ?>">Next</a></li><?php endif; ?>
        </ul>
    </nav>
</div>