                                ...
                                <div class="card" style="width: 18rem; min-height: 24rem; ">
                                    ...
                                    <div class="card-body d-flex flex-column justify-content-between">
                                        <div>
                                            ...
                                            <p class="card-text text-dark"><?= htmlspecialchars($book["kategori_buku"])?></p>
                                        </div>
                                        <p class="card-text"><?= substr(htmlspecialchars($book["deskripsi_buku"]), 0, 75);?>...<i>Baca Selengkapnya</i></p>
                                    </div>
                                </div>
                            </a>
                        </div>
