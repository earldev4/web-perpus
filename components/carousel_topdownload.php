<div class="carousel-section">
    <div class="container py-1">
        <div class="section-header d-flex  flex-column align-items-center">
            <h2 class="section-title fs-1">Top 6 Buku Dengan Download Terbanyak</h2>
            <p class="section-subtitle fs-4">Berikut adalah top 6 buku dengan unduhan terbanyak</p>
        </div>
        <?php if(isset($books_top)){?>
