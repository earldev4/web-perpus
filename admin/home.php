            ...
            <div class="col-md-10 col-12 bg-success">
                <div>
                    ...
                    <form action="home.php" method="POST" id="form_hero" name="form_hero" >
                        ...
                        <textarea class="form-control" name="hero_title" id="hero_title" rows="4" cols="50" required placeholder="cth: Selamat Datang di Perpustakaan..." autocomplete="off"><?= isset($heroText["hero_desc"])? htmlspecialchars($heroText["hero_desc"]): "Teks tidak ada" ?></textarea><br>
                ...
                <div>
                    ...
                    <form action="home.php" method="POST" id="form_click" name="form_click">
                        <label for="clicks" class="form-label">Jumlah Klik</label><br>
                ...
                <div class="p-3">
                    ...
                    <form action="home.php" method="POST" id="form_footer" name="form_footer">
                        ...
                        <textarea  class="form-control" name="footer_text" id="footer_text" rows="4" autocomplete="off" cols="50" required placeholder="cth: Bandar Lampung merupakan..."><?= isset($footerInfo["footer_text"])? htmlspecialchars($footerInfo["footer_text"]) : "Teks tidak ada" ?></textarea><br>
                        <p class="text-danger" id="footer_text_error"></p>
                        <label for="footer_kontak" class="form-label">Footer kontak</label><br>
                        <input class="form-control" type="text" name="footer_kontak" autocomplete="off" id="footer_kontak" value="<?= isset($footerInfo["kontak"]) ? htmlspecialchars($footerInfo["kontak"]) : "Tidak Ada Kontak" ?>" required placeholder="cth: 0821..."><br>
                        <p class="text-danger" id="footer_kontak_error"></p>
                        <label class="form-label" for="footer_email">Footer email</label><br>
                        <input class="form-control" type="text" name="footer_email" autocomplete="off" id="footer_email" value="<?= isset($footerInfo["email"]) ? htmlspecialchars($footerInfo["email"]) : "Tidak Ada Email" ?>" required placeholder="cth: example@gmail.com"><br>
                        <p class="text-danger" id="footer_email_error"></p>
                        <label class="form-label" for="footer_hari">Footer Hari</label><br>
                        <input class="form-control" type="text" name="footer_hari" autocomplete="off" id="footer_hari" value="<?= isset($footerInfo["hari"]) ? htmlspecialchars($footerInfo["hari"]) : "Tidak Ada Hari" ?>" required placeholder="cth: Senin - Sabtu"><br>
                        <p class="text-danger" id="footer_hari_error"></p>
                        <label class="form-label" for="footer_jam">Footer Jam</label><br>
                        <input class="form-control" type="text" name="footer_jam" autocomplete="off" id="footer_jam" value="<?= isset($footerInfo["jam"]) ? htmlspecialchars($footerInfo["jam"]) : "Tidak Ada Jam" ?>" required placeholder="cth: 08:00 - 17:00"><br>
                        <p class="text-danger" id="footer_jam_error"></p>
                        <label class="form-label" for="footer_lokasi">Footer lokasi</label><br>
                        <textarea class="form-control" rows="4" cols="50" name="footer_lokasi" autocomplete="off" id="footer_lokasi" required placeholder="cth: Jl. Sukamakan No 1..."><?= isset($footerInfo["lokasi"]) ? htmlspecialchars($footerInfo["lokasi"]) : "Tidak Ada Lokasi" ?></textarea><br>
