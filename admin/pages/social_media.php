            ...
            <div class="col-md-10 col-12 bg-success">
                <div>
                    ...
                    <form action="home.php" method="POST" id="form_hero" name="form_hero" >
                        ...
                        <textarea class="form-control" autocomplete="off" name="hero_title" id="hero_title" rows="4" cols="50" required placeholder="cth: Selamat Datang di Perpustakaan..."><?= isset($heroText["hero_desc"]) ? htmlspecialchars($heroText["hero_desc"]) : "" ?></textarea><br>
