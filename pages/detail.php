...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <img src="../assets/img/thumbnail/<?= $book["thumbnail_buku"]?>" alt="Book in a library">
        </div>
        <div class="row pt-2">
            ...
            <div class="col-md-7 col-12">
                <p style=""><?= isset($book['deskripsi_buku']) ? $book['deskripsi_buku'] : "Tidak ada deskripsi buku"; ?></p>
            </div>
        </div>
    </div>
